...
function ConstructBittomPanel()
{
	...
	const uiGameInboxButtonLabelLocalLeftScale = 0.3;
	const uiGameInboxButtonLabelLocalTopScale = 0.4;
	...
	const uiGameGiftsButtonLabelLocalTopScale = 0.4;
	...
	const uiGameBuyButtonLabelLocalLeftScale = 0.3;
	const uiGameBuyButtonLabelLocalTopScale = 0.4;
	...
	const uiGameFriendsButtonLabelLocalLeftScale = 0.4;
	const uiGameFriendsButtonLabelLocalTopScale = 0.4;
	...
	const uiGameMegaBonusPanelHeightScale = 0.125;
	const uiGameMegaBonusPanelLeftScale = 0.29;
	const uiGameMegaBonusPanelTopScale = 0.85;
	...
	const uiGameMegaBonusLabelLeftScale = 0.28;
	const uiGameMegaBonusLabelTopScale = 0.55;
	uiGameMegaBonusLabelLeft = uiGameMegaBonusPanelWidth * uiGameMegaBonusLabelLeftScale;
	uiGameMegaBonusLabelTop = uiGameMegaBonusPanelHeight * uiGameMegaBonusLabelTopScale;
