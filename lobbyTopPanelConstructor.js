...
function ConstructTopPanel()
{
	...
	var topPanelHTML = '<div id = \"uiTopPanel\"; style = \" background-color: Transparent; width:' + uiGameTopPanelWidth + 'px; height: ' + uiGameTopPanelHeight + 'px \">  \
							...
							<img id = \"expPanelTexture\"; style="position:absolute; width: ' + uiGameExperiencePanelWidth*1.14 + 'px; height: ' + uiGameExperiencePanelHeight + 'px; left: ' + (uiGameExperiencePanelLeft+uiGameExperiencePanelWidth*0.25) + 'px; top: ' + uiGameExperiencePanelTop + 'px"></img>\
							<div id = \"expPanel\"; style = \"text-align: center; color: #ffffff; position: absolute; width: ' + uiGameExperiencePanelWidth*1.14 + 'px; height: ' + uiGameExperiencePanelHeight + 'px; left: ' + (uiGameExperiencePanelLeft+uiGameExperiencePanelWidth*0.25) + 'px; top: ' + uiGameExperiencePanelTop + 'px \">'+exp+'/1000</div>\
